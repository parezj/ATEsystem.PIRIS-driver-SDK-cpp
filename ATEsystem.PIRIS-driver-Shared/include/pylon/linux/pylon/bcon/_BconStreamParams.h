...
namespace Basler_BconStreamParams
{
    ...
    */
    ...
    //@{
    /*!
        \brief The PFNC pixel format value configured on the frame grabber.

        The PFNC pixel format value configured on the frame grabber. This parameter is automatically synchronized with the corresponding camera parameter.
    ...
    */
    ...
    //@{
    /*!
        \brief The width of the ROI configured on the frame grabber.

        The width of the ROI configured on the frame grabber. This parameter is automatically synchronized with the corresponding camera parameter.
    ...
    */
    ...
    //@{
    /*!
        \brief The height of the ROI configured on the frame grabber.

        The height of the ROI configured on the frame grabber. This parameter is automatically synchronized with the corresponding camera parameter.
    ...
    */
    ...
    //@{
    /*!
        \brief The clock frequency in Hz configured on the frame grabber.

        The clock frequency in Hz configured on the frame grabber. This parameter is automatically synchronized with the corresponding camera parameter.
    ...
    */
    ...
    //@{
    /*!
        \brief Pixel per clock cycle configured on the frame grabber.

        Pixel per clock cycle configured on the frame grabber. This parameter is automatically synchronized with the corresponding camera parameter.
    ...
    */
    ...
    //@{
    /*!
        \brief The size of the payload in bytes.

        The size of the payload in bytes. This is the total number of bytes of the image data payload produced by the frame grabber. This value is computed by the frame grabber implementation in the BCON Adapter. The pylon stream grabber needs to open to be able to compute the payload size.
